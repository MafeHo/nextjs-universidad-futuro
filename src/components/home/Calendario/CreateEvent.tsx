...
const CreateEvent: React.FC<CreateEventProps> = ({
  ...
  return (
    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
      <DialogContent className="max-h-[550px] overflow-y-auto bg-white dark:bg-gray-900 md:max-w-2xl md:max-h-[660px] ">
        {(user && (
          <>
            <DialogHeader>
            ...
            <form className="space-y-4" onSubmit={handleAddEvent}>
              <div className="">
                <label className="block text-l font-medium">Título</label>
                <input
                  type="text"
              ...
              <div className="grid gap-2 md:grid-cols-2">
                ...
                <div>
                  <label className="block text-l font-medium">Facultad</label>
                  <select
              ...
              <div className="grid gap-4 md:grid-cols-2">
                {/* temática y tipo*/}
                <div>
                  <label className="block font-medium mt-4">Temática</label>
                  <select
              ...
              {/* Cupos máximos*/}
              <div className="mt-4">
                <label className="block font-medium">Cupos Máximos</label>
                <input
                  type="number"
